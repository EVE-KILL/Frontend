			...
			<li class="relative">
				...
				{#if isExternalDropDownOpen}
					...
					>
						...
						<li>
							<a href="https://evemaps.dotlan.net/region/{killmail.region_name}" target="_blank" class="block px-4 py-2 hover:bg-background-700"
						...
						<li>
							<a href="https://evemissioneer.com/r/{killmail.region_id}" target="_blank" class="block px-4 py-2 hover:bg-background-700"
								>{killmail.region_name}</a
							>
						</li>
						...
						<li>
							<a href="https://everef.net/type/{killmail.victim.ship_id}" target="_blank" class="block px-4 py-2 hover:bg-background-700"
						...
						<li>
							<a href="https://www.jita.space/region/{killmail.region_id}" target="_blank" class="block px-4 py-2 hover:bg-background-700"
								>{killmail.region_name}</a
							>
						</li>
					</ul>
