<!-- src/lib/components/Information.svelte -->
<script lang="ts">
...
<div class="relative">
	...
	>
		<i class="fas fa-circle-info text-gray-500 hover:text-gray-400" style="font-size: 32px;"
		></i>
	</button>
	{#if isInformationDropdownOpen}
		...
		>
			<li>
				<a href="/information" class="block px-4 py-2 text-sm text-white hover:bg-gray-700"
					>Information</a
				>
			</li>
			<li>
				<a href="/docs/apidocs" class="block px-4 py-2 text-sm text-white hover:bg-gray-700"
					>API Docs</a
				>
			</li>
			<li>
				<a href="/docs/stomp" class="block px-4 py-2 text-sm text-white hover:bg-gray-700"
					>STOMP Docs</a
				>
			</li>
			<li>
