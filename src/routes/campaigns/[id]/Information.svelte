		...
		<table class="table-auto min-w-full bg-semi-transparent rounded-lg shadow-lg">
			...
			<tbody class="text-gray-300 text-sm">
				...
				>
					...
					<td class="px-2 py-1"
						>{formatNumber(
							campaign.stats.friendlyLosses + campaign.stats.foeLosses,
							0
						)}</td
					>
				</tr>
				...
				>
					...
					<td class="px-2 py-1"
						>{formatNumber(campaign.stats.friendlyTotalValue, 0)} ISK</td
					>
				...
				>
					...
					<td class="px-2 py-1"
						>{formatNumber(
							campaign.stats.friendlyActivePilots + campaign.stats.foeActivePilots,
							0
						)}</td
					>
				</tr>
				...
				>
					...
					<td class="px-2 py-1"
						>{formatNumber(campaign.stats.friendlyActiveCorporations, 0)}</td
					>
					<td class="px-2 py-1"
						>{formatNumber(campaign.stats.foeActiveCorporations, 0)}</td
					>
					<td class="px-2 py-1"
						>{formatNumber(
				...
				>
					...
					<td class="px-2 py-1"
						>{formatNumber(campaign.stats.friendlyActiveAlliances, 0)}</td
					>
					<td class="px-2 py-1">{formatNumber(campaign.stats.foeActiveAlliances, 0)}</td>
					<td class="px-2 py-1"
						>{formatNumber(
							campaign.stats.friendlyActiveAlliances +
								campaign.stats.foeActiveAlliances,
							0
						)}</td
					>
				</tr>
				...
				>
					...
					<td class="px-2 py-1"
						>{formatNumber(campaign.stats.friendlyActiveSystems, 0)}</td
					>
				...
				>
					...
					<td class="px-2 py-1"
						>{formatNumber(campaign.stats.friendlyActiveRegions, 0)}</td
					>
				...
				>
					...
					<td class="px-2 py-1"
						>{formatNumber(campaign.stats.friendlyUsedShipGroups, 0)}</td
					>
