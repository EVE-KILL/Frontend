...
<div class="overflow-x-auto">
		...
		<div class="w-full lg:w-1/2">
			<table class="table-auto min-w-full bg-gray-800 rounded-lg shadow-lg">
				...
				<tbody class="text-gray-300 text-sm">
					...
					>
						<td class="px-2 py-1"
							><code>/exchange/killmail_topic_exchange/character.id</code></td
						>
					...
					>
						<td class="px-2 py-1"
							><code>/exchange/killmail_topic_exchange/corporation.id</code></td
						>
						<td class="px-2 py-1"
							>Emits all killmails for a particular corporation id</td
						>
					</tr>
					<tr
						class="border-b border-gray-700 hover:bg-gray-600 transition-colors duration-300"
					>
						<td class="px-2 py-1"
							><code>/exchange/killmail_topic_exchange/alliance.id</code></td
						>
					...
					>
						<td class="px-2 py-1"
							><code>/exchange/killmail_topic_exchange/faction.id</code></td
						>
					...
					>
						<td class="px-2 py-1"
							><code>/exchange/killmail_topic_exchange/system.id</code></td
						>
					...
					>
						<td class="px-2 py-1"
							><code>/exchange/killmail_topic_exchange/region.id</code></td
						>
	...
	<p class="text-gray-300 mb-4">
		...
		<li>
			1. The connection is not durable, meaning that you will not receive messages that were
...
client.activate();`}
	...
	<p class="text-gray-300 mb-4">
		Note that you will need to install the <code>textalk/websocket</code> package via Composer to
		use this example.
	</p>
...
$client->close();`}
	...
	<p class="text-gray-300 mb-4">
		Once connected and subscribed, you will receive incoming messages containing killmail data
		in JSON format. You can process these messages according to your application's requirements.
	</p>

	<p class="text-gray-300">
		For more advanced usage, including filtering and processing specific data, refer to the full
		API documentation or contact support.
	</p>
</div>
